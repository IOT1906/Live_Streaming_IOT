...
namespace Mcks.Api.Controllers
{
    ...
    public class QiniuController : ControllerBase
    {
        ...
        {
            public static string AccessKey { get; set; } = "YGQCiii-hebYjEKpjZDY789SS_jUkii_8yJtX3ko";
            public static string SecretKey { get; set; } = "7_LmcekWhMZ4J3TM_7HEqTikqJfjFN58wqWcn_Kr";
        }
        ...
        public IActionResult Qiniu(IFormFile file)
        {
            ...
            string bucket = "liujinqi"; //这个是我们在七牛云上创建的“存储空间”名称
            ...
            return Ok(new { img= "http://r9nl1giwk.hn-bkt.clouddn.com/"+saveKey });
        }
    }
}